...
public class UserCommerceAccountSegmentsCriteriaContributor implements SegmentsCriteriaContributor {
	...
	private static final Log _log = LogFactoryUtil.getLog(
			UserCommerceAccountSegmentsCriteriaContributor.class);
	...
	{
		return Collections
				.singletonList(new Field("commerceAccountId", LanguageUtil.get(_portal.getLocale(portletRequest), "Commerce Account"),
