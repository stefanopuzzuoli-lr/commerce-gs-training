...
public class CommerceAccountDisplayContext {
	...
	public CommerceAccountDisplayContext(CommerceAccountService commerceAccountService,
			HttpServletRequest httpServletRequest) {

		_commerceAccountService = commerceAccountService;

		_commerceAccountRequestHelper = new CommerceAccountRequestHelper(httpServletRequest);
	...
	public CommerceAccount getCurrentCommerceAccount() throws PortalException {
		long commerceAccountId = ParamUtil.getLong(_commerceAccountRequestHelper.getRequest(), "commerceAccountId");
	...
	public String getLogo(CommerceAccount commerceAccount) {
		ThemeDisplay themeDisplay = _commerceAccountRequestHelper.getThemeDisplay();
		...
		sb.append("&t=");
		sb.append(WebServerServletTokenUtil.getToken(commerceAccount.getLogoId()));
